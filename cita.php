      ...
      <div class="col-md-12">
          ...
          <form class="formulario" action="#" method="POST">
              <div class="row">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                      <input class="form-control" placeholder="Correo" type="text" name="correo" id="correo" required>
                  </div>
                  <div class=" col-md-6">
                      <input class="form-control" placeholder="Telefono" type="text" name="telefono" id="telefono" required>
                  </div>
                  <div class=" col-md-6">
                      <input class="form-control" placeholder="Fecha" type="text" name="fecha" id="telefono">
                  </div>
                  <div class="col-md-12">
                      <textarea class="textarea" placeholder="Mensaje" id="mensaje"  name="mensaje" required></textarea>
                  </div>
                  <div class=" col-md-12">
                      <!-- <button class="boton" onclick="validar_formulario()">Enviar</button> -->
                      <input class="boton" type="submit" value="Enviar" class="btn" name="registro"> 
                  </div>
              </div>
          </form>
      </div>
...
if(isset ($_POST['registro'])){
    ...
    $mysqli= mysqli_connect($hostname,$username,$password,$database) or die (mysqli_connect_error() );
        ...
        if( $mysqli) {
            ...
            echo "<script> alert('error  conexion')   </script>";

            die('Error de conexion('.mysql_connect_errno().')'.mysql_connetct_error());
        
        }

        $insert="insert into citas (nombre,correo,telefono,mensaje,fecha) values('$nombre','$correo','$telefono','$mensaje','$fecha_formato')";
        $ejecutarInsert=mysqli_query( $mysqli, $insert);
