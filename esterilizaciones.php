            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/esterilizacion.jpeg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                        <h4 id="conocenos" class="d-inline-block text-uppercase border-bottom border-3">Esterilizaciones y castraciones</h4>
                    </div>
                    <p  id= "parrafo">La esterilización es un procedimiento médico veterinario por medio del cual se extraen los órganos reproductores de los animales (macho y hembra) con el objetivo de brindarles beneficios en salud como la prevención de enfermedades y tumores malignos, y también para controlar su natalidad excesiva.</p> 
                    </div>
                </div>
            </div>
        </div>
