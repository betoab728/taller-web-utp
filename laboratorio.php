            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/laboratoriovet.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                        <h4 id="conocenos" class="d-inline-block text-uppercase border-bottom border-3">Laboratorio</h4>                     
                    </div>
                    <p  id= "parrafo">Se realizan estudio de laboratiorio de tipo: Bioquímica (glucosa, pruebas hepáticas, pruebas renales, electrolitos, amilasa pancreática, proteínas etc.) Estudios de coagulación (tiempo de protrombina, fibrinógeno y factores de coagulación específicos) Estudios de orina (bioquímicos, sedimento, citológicos)</p> 
                    </div>
                </div>
            </div>
        </div>
