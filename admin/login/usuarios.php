                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <a class="btn btn-primary" href="usuario_nuevo.php">Nuevo Usuario</a>
                        </div>
                    </div>
                    ...
                    while ($row = $result -> fetch_assoc()) {
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success" href="usuario_editar.php?id=<?php echo "$row[id]" ?>"><i class="fas fa-edit"></i></a>
