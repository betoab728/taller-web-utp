...
if (isset($_POST['btn_buscar'])) {
    ...
    $consulta="select * from productos where descripcion like '%$buscar%'";
    $result= $connection->query($consulta);
}
?>
<!DOCTYPE html>
    ...
    <div class="container my-5" >
            ...
            <div class="container">
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <input type="text" placeholder="Buscar por descripcion" name="buscar" class="form-control" value="<?php if(isset($buscar)) echo $buscar ?>"> 
                        </div>
                        <div class="col-sm-3">
                            <input type="submit" class="btn btn-primary" name="btn_buscar" value="Buscar">
                            <a class="btn btn-primary" href="nuevo.php">Nuevo Producto</a>
                        </div>
                    </div>
                    ...
                    while ($row = $result -> fetch_assoc()) {
                        ?>
                            <tr>
                                ...
                                <td>
                                <img src="IMG/<?php echo $row["imagen"]; ?>" alt="Foto_Producto" style="width: 100px;"> 
                                </td>
                                <td>
                                    <a class="btn btn-success" href="editar.php?id=<?php echo "$row[idproducto]" ?>"><i class="fas fa-edit"></i></a>
