            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/tratamiento.jpeg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                        <h4 id="conocenos" class="d-inline-block text-uppercase border-bottom border-3">Tratamientos</h4>
                    </div>
                    <p  id= "parrafo">Tras haber hecho un diagnóstico, el veterinario deberá optar por un tratamiento. Éste podría ser, por ejemplo, limpiar y vendar las heridas, operar, o una prescripción de medicamentos. Para operar animales, los veterinarios usan sus habilidades manuales, herramientas quirúrgicas y su conocimiento de los anestésicos.</p> 
                    </div>
                </div>
            </div>
        </div>
