            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/vacuna.jpeg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                        <h4 id="conocenos" class="d-inline-block text-uppercase border-bottom border-3">Vacunas</h4>
                    </div>
                    <p  id= "parrafo">Para los perros, existen vacunas obligatorias y opcionales. Las primeras son esenciales debido a que evitan enfermedades que pueden poner en riesgo la vida del peludo e incluso de las personas con las que vive, ya que algunos de estos padecimientos pueden ser transmitidos a los humanos. Las vacunas opcionales también son importantes para preservar la salud de un perro. Sin embargo, deben aplicarse bajo la recomendación de un médico veterinario, quien evaluará si es necesario colocarlas basándose en factores como la edad o el entorno donde habita tu compañero de cuatro patas. </p> 
                    </div>
                </div>
            </div>
        </div>
