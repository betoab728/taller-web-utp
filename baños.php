            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/hana.jpeg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                        <h3 id="conocenos" class="d-inline-block text-uppercase border-bottom border-3">Baños Estéticos</h3>
                    </div>
                    <p  id= "parrafo"> El servicio de Baño Estético que ofrecemos consiste en un baño con Shampoo Hipoalergénico, secado, corte de uñas, limado de uñas, limpieza de oídos y limpieza de glándulas anales. Finalmente nuestros clientes se van con una corbat o un lazo distintivo</p> 
                    </div>
                </div>
            </div>
        </div>
