...
if(isset ($_POST['registro'])){
    ...
    do {
        ...
        $sql="insert into cliente (dni, nombre,apellidos,direccion,telefono,correo, password) "
        ."values ( '$dni','$nombre', '$apellido','$direccion' ,'$telefono', '$correo','$pass_encriptada')";
...
<html lang="en">
<head>
    <link rel="stylesheet" href="css/estilo-nuevocliente.css">
    <meta charset="UTF-8">
...
<body class="fondo" style="background-image: url(./img/xd.jpg);">
<section>
                ...
                <div class="col-sm-8">
                    <form action="#" method="post">
                        <div class="row mb-3">
                            ...
                            <div class="col">
                            <h2 class="text-center text-light p-3 " style="background-color:#5f3061;">Nuevo Cliente</h2>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                 <label for="">DNI</label>
                                 <input type="text" class="form-control" name="dni" value="" required>
                        ...
                        <div class="row mb-3 justify-content-center">
                            ...
                            <div class="col-sm-6 d-grid">
                                <a class="btn btn-primary" href="LoginCliente.php">Cancelar</a>
                            </div>
                        </div>
