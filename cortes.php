...
<div class="container-slider">
    <div class="slider" id="slider">
        <div class="slider_img">
              ...
              <img class="slider__img" src="./img/lucas.jpg" alt="Imagen 1">
            
        </div>
        <div class="slider_img">
          
            <img class="slider__img" src="./img/tequila.jpg" alt="Imagen 2">
        </div>
        <div class="slider_img">
          
            <img class="slider__img" src="./img/rapado.jpg" alt="Imagen 3">
        </div>
    </div>
            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/tequila2.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                        <h3 id="conocenos" class="d-inline-block text-uppercase border-bottom border-3">Cortes</h3>
                    </div>
                    <p  id= "parrafo">En el servicio de Corte de Pelo, realizamos un baño previamente a la mascota y cortamos de acuerdo a la preferencia del dueño, algunas razas de perros tienen un corte específico como : Corte Schnauzer , Corte Shitzu o Corte Caniche(Poodle), también realizamos rapados totales.</p> 
                    </div>
                </div>
            </div>
        </div>
